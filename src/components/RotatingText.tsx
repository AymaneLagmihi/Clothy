...
const RotatingText = forwardRef<RotatingTextHandle, RotatingTextProps>((props, ref) => {
  ...
  // Add a type guard for Intl.Segmenter to avoid TypeScript error
  const splitIntoCharacters = (text: string) => {
    // @ts-ignore: Intl.Segmenter may not be typed in TypeScript
    if (typeof Intl !== 'undefined' && typeof (Intl as any).Segmenter === 'function') {
      // @ts-ignore: Use Segmenter if available
